    ...
    if request.method == 'POST':
        if create_form.is_valid():
            ...
            if create_form.instance.setNameToAnonymous == False:
                ...
                if request.user.publicuser.username:
                    create_form.instance.author = '{}'.format(
                    request.user.publicuser.username)
                else:
                    create_form.instance.author = '{} {}'.format(
            ...
            create_form.save()
            messages.success(
                request, 'Thank you so much for your submittion, may your testimony be permanent in Jesus name! please check the status of your testimony through your user dashboard and also share to your friends. If you have any problem with activating your testimony please contact us through the contact form')
